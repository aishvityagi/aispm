...
describe('ensureIndex', () => {
    ...
    it('creates index if it does not exist', async () => {
        ...
        expect(mockIndicesCreate).toHaveBeenCalledWith(expect.objectContaining({ index: 'audit_events' }));
    });
...
describe('indexAuditEvent', () => {
    ...
    it('indexes a document with correct fields', async () => {
        ...
        await (0, elasticsearch_1.indexAuditEvent)(event);
    ...
    it('does not throw if indexing fails', async () => {
        ...
        await expect((0, elasticsearch_1.indexAuditEvent)({ id: 1 })).resolves.not.toThrow();
    });
});
describe('searchAuditEvents', () => {
    ...
    it('returns mapped results from Elasticsearch', async () => {
        ...
        const results = await (0, elasticsearch_1.searchAuditEvents)('quantum', 10);
    ...
    it('uses multi_match query across correct fields', async () => {
        ...
        await (0, elasticsearch_1.searchAuditEvents)('test query', 5);
...
//# sourceMappingURL=elasticsearch.test.js.map