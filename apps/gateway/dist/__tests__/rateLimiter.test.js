...
describe('checkUserRateLimit', () => {
    ...
    it('allows request when under limit', async () => {
        ...
        const result = await (0, rateLimiter_1.checkUserRateLimit)(mockFastify, 'user-123');
    ...
    it('sets expiry on first request', async () => {
        mockIncr.mockResolvedValue(1);
        mockExpire.mockResolvedValue(1);
        await (0, rateLimiter_1.checkUserRateLimit)(mockFastify, 'user-123');
    ...
    it('uses correct Redis key format', async () => {
        mockIncr.mockResolvedValue(1);
        mockExpire.mockResolvedValue(1);
        await (0, rateLimiter_1.checkUserRateLimit)(mockFastify, 'test-user-456');
