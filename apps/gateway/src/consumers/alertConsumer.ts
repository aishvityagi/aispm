...
const consumer: Consumer = kafka.consumer({ groupId: 'alert-group' });

// Build a Slack message block from event data
function buildSlackMessage(eventType: string, data: any): object {
...
async function sendSlackAlert(eventType: string, data: any): Promise<void> {
